...
export default defineComponent({
	...
	setup(props, { slots }) {
		return () => {
			const { sku, goods, skuEventBus, selectedSku, showHeaderImage = true } = props
			console.log(sku)
			const selectedValue = getSkuImgValue(sku as SkuData, selectedSku as SelectedSkuData)
			...
			return (
				<div class={[bem(), BORDER_BOTTOM]}>
					{showHeaderImage && (
						<Image fit="cover" src={imgUrl} class={bem('img-wrap')} onClick={previewImage}>
