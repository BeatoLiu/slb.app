...
export default defineComponent({
    ...
    computed: {
        ...
        isSkuCombSelected(): boolean {
            // console.log(this.hasSku && !isAllSelected(this.skuTree, this.selectedSku))
            // SKU 未选完
        ...
        selectedSkuComb(): {
            ...
            let skuComb = null;
            // console.log(this.isSkuCombSelected)
        ...
        price(): string {
            if (this.selectedSkuComb) {
                // console.log(this.selectedSkuComb)
                return (
    ...
    methods: {
        ...
        resetSelectedSku() {
            ...
            // 重置 selectedSku
            this.skuTree.forEach((item) => {
                item.k_s && (this.selectedSku[item.k_s] = UNSELECTED_SKU_VALUE_ID);
            });
            this.skuTree.forEach((item) => {
                const key = item.k_s;
                // 规格值只有1个时，优先判断
            ...
            // console.log(this.skuTree, this.selectedSku)
        ...
        // clickCloseIcon(event: any) {
        //     this.$emit('update:show', event)
        // }
    },
    ...
    render() {
        ...
        const Stepper = slots["sku-stepper"]?.(slotsProps) || (
            ...
            // (event: MouseEvent) => this.$emit("stepper-change", event)
            />
        );
        ...
        return (
            ...
            //     onOpened={() => { }}
            //     onClick-close-icon={() => this.clickCloseIcon(false)}
            // >
            <div>
