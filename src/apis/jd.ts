...
import {
	IGetProductDetailStyleModel,
	IGetProductSkuImageMode, IGetProductSkuImageRes,
	ISku
} from "./model/jdModel";
 ...
 * @returns
 */
export const getProductDetailStyle = (p: IGetProductDetailStyleModel) => httpPost<IBaseResT<string>>(Apis.GET_PRODUCT_DETAIL_STYLE, p)
 ...
 * @returns
 */
export const getProductSkuImage = (p: IGetProductSkuImageMode) => httpPost<IGetProductSkuImageRes>(Apis.GET_PRODUCT_SKU_IMAGE, p)
