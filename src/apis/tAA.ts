 ...
 * @returns
 */
export const changeWalletAcctOnChainForOutZs = (p: ITransferModel) =>
	httpPost<IBaseResT>(Api.CHANGE_WALLET_ACCT_ON_CHAIN_FOR_OUT_ZS, p)
 ...
 * @returns
 */
export const changeWalletAcctOnChainForInZs = (p: Omit<ITransferModel, 'allianceWalletPassword'>) =>
	httpPost<IBaseResT>(Api.CHANGE_WALLET_ACCT_ON_CHAIN_FOR_IN_ZS, p)

/**
 * @description 查询TAA K线图 薄饼交易
 * @returns
 */
export const getTransferInfoKLineGraph = () =>
	httpPost<IGetTransferInfoKLineGraphRes>(Api.GET_TRANSFER_INFO_K_LINE_GRAPH)
