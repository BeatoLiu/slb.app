                    ...
                    <div class="login-cont">
                        <CellGroup>
                            <div class="flex-space img-item">
                                <p>卡照</p>
                                <Uploader v-model={[imgList.value]} after-read={afterRead} upload-text="卡正面照" max-count="1" />
                                <Button type="primary" disabled={!imgList.value.length || data.imgMsg !== '上传'} onClick={upload}>{
                                    data.imgMsg
                                }</Button>
                            </div>
